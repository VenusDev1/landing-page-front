    ...
    return (
        <div className='w-[100%] h-[100vh] flex flex-col '>
            ...
            <div className="w-[100%] h-[90%] flex items-center ">
                <div className=' bg-gradient-to-b w-[100%] flex flex-col lg:flex-row lg:justify-around justify-center items-center lg:bg-gradient-to-l from-[#f1e2b5] via-[#F5E4B1] to-[#252525] pb-10'>   
